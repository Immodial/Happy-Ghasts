...
## >> Input: None
execute on passengers if entity @s[tag=HGDriedGhasticleRightMid] run return fail
summon item_display ~ ~ ~ {Tags:["HGDriedGhastDisplay","HGFloorGhasticle","HGRightGhasticle","HGDriedGhasticleRightMid","HGDriedGhastFormatting"],item:{id:"stone",components:{item_model:"happy:dried_ghasticle"}},teleport_duration:2,interpolation_duration:20}
...
scoreboard players add @n[tag=HGDriedGhastFormatting] HGGhasticleTime 7
