...
## >> Input: None
execute on passengers if entity @s[tag=HGDriedGhasticleRightFront] run return fail
summon item_display ~ ~ ~ {Tags:["HGDriedGhastDisplay","HGFloorGhasticle","HGRightGhasticle","HGDriedGhasticleRightFront","HGDriedGhastFormatting"],item:{id:"stone",components:{item_model:"happy:dried_ghasticle"}},teleport_duration:2,interpolation_duration:20}
