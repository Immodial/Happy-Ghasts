...
## >> Input: None
execute on passengers if entity @s[tag=HGHappyGhastBody] run return fail
summon item_display ~ ~ ~ {Tags:["HGHappyGhastDisplay","HGHappyGhastBody","HGHappyGhastFormatting"],item:{id:"stone",components:{item_model:"happy:happy_ghast"}},teleport_duration:2}
